            ...
            <div className="sticky top-32 space-y-6">
              <div className="bg-white border border-[#E8E5DF] p-8 rounded-sm shadow-xl shadow-black/5">
                ...
                <div className="space-y-3 mb-8">
                  ...
                  <a href="https://wa.me/9779851146179" target="_blank" rel="noopener noreferrer" className="block w-full py-4 bg-[#25D366] text-white text-center text-sm tracking-widest uppercase hover:bg-[#128C7E] transition-colors rounded-sm flex flex-col items-center justify-center gap-1">
                    ...
                    <span className="text-[10px] normal-case opacity-90 block mt-0.5 tracking-widest">+977 985-1146179</span>
                  </a>
                  <a href="https://line.me/ti/p/~+9779851146179" target="_blank" rel="noopener noreferrer" className="block w-full py-4 bg-[#00C300] text-white text-center text-sm tracking-widest uppercase hover:bg-[#00A000] transition-colors rounded-sm flex flex-col items-center justify-center gap-1">
                    <div className="flex items-center gap-2">
