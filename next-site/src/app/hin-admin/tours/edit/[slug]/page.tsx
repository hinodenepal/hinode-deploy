...
import { 
  ...
  CheckCircle, HelpCircle, Eye, Search, Plus, Trash2, Loader2
} from "lucide-react";
      ...
      try {
        ...
        if (tourData.success) {
          ...
          setFormData({
            ...
            enTitle: t.enTitle || "",
            slug: t.slug || "",
            duration: t.duration || "10日間",
            enDuration: t.enDuration || "10 Days",
            season: t.season || "春・秋",
            enSeason: t.enSeason || "Spring / Autumn",
            difficulty: t.difficulty || "Moderate",
            enDifficulty: t.enDifficulty || "Moderate",
            price: t.price || "¥500,000",
            showPrice: t.showPrice !== undefined ? t.showPrice : true,
            image: t.image || "",
            destination: t.destination || "",
            description: t.description || "",
            enDescription: t.enDescription || "",
            metaTitle: t.metaTitle || "",
            enMetaTitle: t.enMetaTitle || "",
            metaDescription: t.metaDescription || "",
            enMetaDescription: t.enMetaDescription || "",
            focusKeywords: t.focusKeywords || "",
            enFocusKeywords: t.enFocusKeywords || "",
          });
          
          // Map arrays back to {ja, en} pairs
          const hlJa = t.highlights || [];
          const hlEn = t.enHighlights || [];
          const mappedHighlights = hlJa.map((h: string, i: number) => ({ ja: h, en: hlEn[i] || "" }));
          setHighlights(mappedHighlights);
          
          setItinerary(t.itinerary || []);
          
          const incJa = t.inclusions || [];
          const incEn = t.enInclusions || [];
          setInclusions(incJa.map((inc: string, i: number) => ({ ja: inc, en: incEn[i] || "" })));
          
          const excJa = t.exclusions || [];
          const excEn = t.enExclusions || [];
          setExclusions(excJa.map((exc: string, i: number) => ({ ja: exc, en: excEn[i] || "" })));
        ...
        setError("Failed to fetch tour package details.");
      } finally {
        setFetching(false);
      }
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setError(data.error || "Failed to update tour package.");
      }
    } catch (err) {
        ...
        <div className="container mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h1 className="text-2xl font-light tracking-widest text-white">Edit Tour Package</h1>
            </div>
          </div>
          <button
